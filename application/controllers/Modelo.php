...
class Modelo extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->dc->setController('Modelo'); // Dados Controller (dc)
    ...
    private function loadModel() {
        ...
        $this->load->model('Model_modelo', 'modelo');
        return(NULL);
    }

    public function cadastrar() {
        $this->dados['dadosEstilo']['titulo_pagina'] = 'Equipamento';
        $this->dados['dadosEstilo']['titulo_aplicacao'] = 'Cadastrar Modelo do Equipamento';
        $this->dados['dadosFormOpen'] = $this->controller . '/Validar';
        $this->dados['my_dados_DB']['agrupamentoFields'] = $this->crud->groupBy('tab_construct', 'str_agrupamento', $where = array('str_aplicacao' => 'Equipamento-Modelo'), 'str_tab_index ASC');
        $this->dados['my_dados_DB']['form'][0] = $this->crud->read('tab_construct', array('str_aplicacao' => 'Equipamento-Modelo'), 'str_tab_index ASC');
