...
class Tipo extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->dc->setController('Tipo'); // Dados Controller (dc)
    ...
    private function loadModel() {
        ...
        $this->load->model('Model_tipo', 'tipo');
        return(NULL);
    }

    public function cadastrar() {
        $this->dados['dadosEstilo']['titulo_pagina'] = 'Equipamento';
        $this->dados['dadosEstilo'][0]['titulo_aplicacao'] = 'Cadastrar Tipo do Equipamento';
        $this->dados['dadosFormOpen'][0]['form'] = $this->controller . '/Insert';
        $this->dados['my_dados_DB'][0]['agrupamentoFields'] = $this->crud->groupBy('tab_construct', 'str_agrupamento', $where = array('str_aplicacao' => 'Tipo-Cadastrar'), 'str_tab_index ASC');
        $this->dados['my_dados_DB'][0]['form'] = $this->crud->read('tab_construct', array('str_aplicacao' => 'Tipo-Cadastrar'), 'str_tab_index ASC');
