...
class Googlemaps {
    ...
    var $adsense = FALSE;                              // Se o Google AdSense para conteúdo deve ser ativado
    var $adsenseChannelNumber = '';                    // O número do canal Adsense para acompanhar o desempenho deste AdUnit
