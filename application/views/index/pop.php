...
?>
    ...
    <body onLoad=”javascript:window.clear.history(0)”>
        <div id="tudo" style="width:100%;">
            <div id="divTop" style="height:0px;">
                &emsp;
            </div>
            <div id="divLeft">
                <?= $this->load->view('index/left'); ?>
            </div>
            <div id="divContent" style="margin: 0px 0px 0px 0px;">
            ...
            <div id="divBottom" style="height:0px; margin: 0px 0px 0px 0px;">
                &emsp;
            </div>
        </div>
    </body>
