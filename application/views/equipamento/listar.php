...
<div>
    ...
    foreach ($my_dados_DB['tabela'][0]['conteudo']['result'] as $value) {
        ...
        if ($controller == 'Equipamento' && $metodo == 'listar') {
            $add_row[$i++] = ($value['bol_ativo'] == 'Y') ? (anchor_popup(base_url($controller . "/desativar/" . $value['str_pk_equipamento']), "<DIV class = 'verde'>" . "[D]" . "</DIV>", $atts)) : ("<DIV class = 'laranja'>" . "[D]" . "</DIV>");
        ...
        if ($controller == 'Funcionario' && $metodo == 'listar') {
            $add_row[$i++] = ($value['bol_ativo'] == 'Y') ? (anchor_popup(base_url($controller . "/desativar/" . $value['str_pk_funcionario']), "<DIV class = 'verde'>" . "[D]" . "</DIV>", $atts)) : ("<DIV class = 'laranja'>" . "[D]" . "</DIV>");
