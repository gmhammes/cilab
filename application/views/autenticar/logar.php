<?php
//C:\xampp\htdocs\cilab\v1\cilab\application\views\autenticar\logar.php
?>
...
$dados['set_value'] = (isset($my_dados_DB[0]['atualizar'])) ? ($my_dados_DB[0]['atualizar']['result'][0]) : (array('str_pk_chave_operacao' => $str_chave));
